...
# Install npm dependencies before compiling assets
WORKDIR /app/assets
RUN npm install

# Return to app directory and compile assets
WORKDIR /app
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/tiphx ./
